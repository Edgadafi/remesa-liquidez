...
const USDC_TESTNET =
  "GBBD47IF6LWK7P7MDEVSCWR7DPUWV3NY3DTQVOFLHG7PGYHT5A7YGN32"; // Circle testnet USDC
const USDC_MAINNET =
  "GA5ZSEJYB37JRC5AVCIA5MOP4RHTM335X2PTHRJDQDFBSEXDDCHIZTLL"; // Circle mainnet USDC
